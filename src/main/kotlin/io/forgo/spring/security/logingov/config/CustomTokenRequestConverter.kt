...
class CustomTokenRequestConverter(clientRegistryRepository: ClientRegistrationRepository, sslUtil: SSLUtil) : OAuth2AuthorizationCodeGrantRequestEntityConverter() {

    open val clientRegistryRepository = clientRegistryRepository
    open val sslUtil = sslUtil
    ...
    override fun convert(authorizationCodeGrantRequest: OAuth2AuthorizationCodeGrantRequest): RequestEntity<*>? {
        ...
        if(registrationId == LOGIN_GOV_REGISTRATION_ID) {
            ...
            val jwt: String = JWT.create()
                    ...
                    .sign(Algorithm.RSA256(sslUtil.rsaPublicKey(),sslUtil.rsaPrivateKey()))
